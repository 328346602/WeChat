...
namespace SWX
{
    public partial class TextMessageList2 : PageBase
    {
        private static int pageSize = 3;//页面显示数目初始化
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (action == "deleteText")
                {
                    ...
                    sb1.AppendFormat("delete from SWX_TextMessage where Id = {0}", id);
                    arrayList.Add(sb1.ToString());
                    StringBuilder sb2 = new StringBuilder();
                    sb2.AppendFormat("delete from SWX_ImgItem where TextMessageId = {0}", id);
                    arrayList.Add(sb2.ToString());
                    bool istrue = MSSQLHelper.ExecuteSqlTran(arrayList);
